; gcc-11 -g -o plus plus.c
; objdump -d -M intel plus > plus.s

plus:     file format elf64-x86-64
...
0000000000001040 <_start>:
    ...
    1058:	48 8d 3d e2 00 00 00 	lea    rdi,[rip+0xe2]        # 1141 <main>
...
0000000000001129 <plus>:
    1129:	f3 0f 1e fa          	endbr64 
    112d:	55                   	push   rbp			; Remember base pointer
    112e:	48 89 e5             	mov    rbp,rsp			; rbp holds stack pointer.
    1131:	89 7d fc             	mov    DWORD PTR [rbp-0x4],edi  ; DWORD(4 bytes) pointer which indicates rbp-4 holds edi value.
    1134:	89 75 f8             	mov    DWORD PTR [rbp-0x8],esi
    1137:	8b 55 fc             	mov    edx,DWORD PTR [rbp-0x4]	; To add
...
0000000000001141 <main>:
    ...
    1149:	be 04 00 00 00       	mov    esi,0x4
    114e:	bf 03 00 00 00       	mov    edi,0x3
    1153:	e8 d1 ff ff ff       	call   1129 <plus>
    1158:	5d                   	pop    rbp
    1159:	c3                   	ret    
